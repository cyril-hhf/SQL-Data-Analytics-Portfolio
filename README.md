...
## 📈 Analytical Highlights & Advanced Queries

### 1. Customer Cohort Retention Analysis (`03_analytics/07_customer_cohort_retention.sql`)
...
### 2. Shipping Cost vs. Speed Correlation Engine (`03_analytics/05_shipping_cost_efficiency.sql`)
...
### 3. RFM Customer Behavioral Segmentation (`03_analytics/08_rfm_customer_segmentation.sql`)
...
* `/03_analytics`: Production-ready advanced analytical queries.
